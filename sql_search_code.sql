...
-- DialogScript
union
select 'DialogScript' as ObjectType, 'Scriptcode' as ObjectAttribute, ScriptName as ObjectName, XObjectKey as ObjectKey from DialogScript where ScriptCode like '%'+@keyword+'%' and (dbo.QBM_FCVGUIDToModuleOwner(UID_DialogScript) = 'CCC' or @onlyCustomScripts=0)
